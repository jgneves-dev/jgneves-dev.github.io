...
export const Projects = () => {
  ...
  const projects = [
    ...
    {
      image: "../src/assets/rom-thumb.png",
      languages: ["C++, Unreal Engine 4"],
    ...
    {
      image: "../src/assets/bat-thumb.png",
      languages: ["GBStudio"],
      title: "By a Thread",
